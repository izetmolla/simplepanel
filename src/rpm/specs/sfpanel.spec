...
Provides:       sfpanelcp sfpanel-api sfpanel

%define         _sfpaneldir  /usr/local/%{name}

%description
This package contains the packages for Sfpanel Control Panel api.
...
%post
if [ $1 -ge 2 ]; then
    if [ -x /usr/local/sfpanel/upd/add_sudo.sh ]; then
        /usr/local/sfpanel/upd/add_sudo.sh
    fi
    if [ -x /usr/local/sfpanel/upd/add_notifications.sh ]; then
        /usr/local/sfpanel/upd/add_notifications.sh
    fi
    if [ -x /usr/local/sfpanel/upd/fix_sessions.sh ]; then
        /usr/local/sfpanel/upd/fix_sessions.sh
    fi
    if [ -x /usr/local/sfpanel/upd/fix_nginx_auth.sh ]; then
        /usr/local/sfpanel/upd/fix_nginx_auth.sh
    fi
    if [ -x /usr/local/sfpanel/upd/fix_roundcube.sh ]; then
        /usr/local/sfpanel/upd/fix_roundcube.sh
    fi

    if [ -x /usr/local/sfpanel/upd/limit_sudo.sh ]; then
        /usr/local/sfpanel/upd/limit_sudo.sh
    fi

    if [ -x /usr/local/sfpanel/upd/fix_dhcprenew.sh ]; then
        /usr/local/sfpanel/upd/fix_dhcprenew.sh
    fi

fi
%files
%{_sfpaneldir}
%config(noreplace) %{_sfpaneldir}/web/images/sprite.png
%config(noreplace) %{_sfpaneldir}/web/images/favicon.ico
%config(noreplace) %{_sfpaneldir}/web/css/file_manager.css
%config(noreplace) %{_sfpaneldir}/web/css/file_manager_editor.css
%config(noreplace) %{_sfpaneldir}/web/css/jquery.arcticmodal.css
%config(noreplace) %{_sfpaneldir}/web/css/jquery-custom-dialogs.css
%config(noreplace) %{_sfpaneldir}/web/css/jquery.fileupload.css
%config(noreplace) %{_sfpaneldir}/web/css/styles.min.css
%config(noreplace) %{_sfpaneldir}/web/css/uploadify.css

%changelog
* Fri Feb 25 2022 Serghey Rodin <builder@sfpanel.izetmolla.com> - 1.0.0-6
- Frontend bugfixes

* Mon Nov 22 2021 Serghey Rodin <builder@sfpanel.izetmolla.com> - 1.0.0-5
- Bugfixes

* Mon Nov 1 2021 Serghey Rodin <builder@sfpanel.izetmolla.com> - 1.0.0-4
- Merge pull request #2128 to fix LE related issues in UI

* Sun Oct 31 2021 Serghey Rodin <builder@sfpanel.izetmolla.com> - 1.0.0-3
- Merge pull request #2108 and #2109

* Sat Oct 30 2021 Serghey Rodin <builder@sfpanel.izetmolla.com> - 1.0.0-2
- Merge pull request #2074 from mix5003/fix-fi

* Sat Oct 30 2021 Serghey Rodin <builder@sfpanel.izetmolla.com> - 1.0.0-1
- Modern Web UI based on React
- Bugfixes

* Sat Sep 29 2019 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-26
- Let's Encrypt HTTP/2 support

* Thu Aug 15 2019 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-25
- Security bugfixes
- LEv2 idn fix

* Mon Apr 18 2019 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-24
- Bugfixes
- Security patches
- LEv2
- Server LE
...
* Thu Oct 18 2018 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-23
- Security fixes

* Wed Jun 27 2018 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-22
- Security fixes

* Fri May 11 2018 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-21
- Additional security fixes

* Sun Apr 08 2018 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-20
- Hardening password checks

* Wed Jan 10 2018 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-19
- Fixed backup restore function

* Fri Dec 29 2017 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-18
...
* Mon Nov 14 2016 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-17
...
* Mon Jun 27 2016 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-16
...
* Fri Nov 06 2015 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-15
...
* Wed Jun 03 2015 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-13
- New UI
- PHP-FPM support
- Security improvements
- Dozen bugfixes

* Wed Oct 23 2014 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-12
- Firewall service handler for Debian and Ubuntu
- Minor i18n fix

* Wed Oct 22 2014 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-11
- Firewall support
- Fail2ban support
...
* Mon Aug 4 2014 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-10
- New Design
- MultiFTP Support
- Exim Queue Chart
...
* Sun May 18 2014 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-9
...
* Fri Apr 18 2014 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-8
- Auto Updates
- Backup Exclusions
...
* Tue Feb 18 2014 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-7
- CSR Generator
...
* Wed Nov 27 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-6
...
* Mon Oct 15 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-5
...
- From now sfpanel.conf can override any func variable
- Ubuntu LTS 12.04/13.04 and Debian 7 are now officially supported

* Tue Sep 17 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-4
- DNS cluster 5-minute sync improvement
- Crontab ownership fix
- Fix for nginx template switcher
- Fix for LoadAverage check

* Mon Jul 30 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-3
...
* Mon Jun 10 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-2
...
* Mon May 27 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.8-1
- DNS Cluster
...
* Mon Apr 08 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-21
...
* Fri Apr 05 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-21
- i18n fix for IDN domain names
- fixed bandwidth calculation

* Tue Apr 03 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-20
...
* Thu Mar 05 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-19
...
* Wed Feb 27 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-18
- Web API wrapper
...
* Mon Feb 18 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-17
...
* Mon Jan 28 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-16
- new color scheme
- i18n support
- idn fix for awstats
- service manager
...
* Mon Jan 14 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-15
...
* Tue Jan 08 2013 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-14
...
* Mon Dec 24 2012 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-13
...
* Mon Dec 17 2012 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-12
- renamed SSL Certificate Authority field
- fixed history log page for users

* Sun Dec 16 2012 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-11
- disabled ssl check function for startssl certificates

* Sun Dec 16 2012 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-10
- fixed bug in ip change function
- replaced cancel with back on control buttons

* Sat Dec 01 2012 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-3
- hotfix for mysql unsuspend function

* Thu Nov 29 2012 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-2
- hotfix for user valudation function

* Sun Jul 01 2012 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.7-1
- New web interface
- Mail api
- Changed sfpanel user with admin

* Wed Jan 25 2012 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.6-3
- Alpha preview of 'login as' function

* Tue Jan 24 2012 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.6-2
- Bugfix: nginx include + dublicate ip adresses in listing

* Tue Jan 17 2012 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.6-1
- Web interface
- Rebuild functions
- RRD support
...
* Tue Sep 13 2011 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.5-2
- small fixes to domain function

* Tue Sep 13 2011 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.5-1
...
- improved sfpanel install scenario

* Tue Jul 05 2011 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.4-1
...
* Tue Jan 04 2011 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.3-3
- new rpm spec without updates to code

* Sun Jan 02 2011 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.3-2
- many fixes to installer
- added condition to upgrade macro in spec file
- fixed v_add_web_alias_script
- updated disk.pipe

* Tue Dec 28 2010 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.3-1
- excluded sfpanel user from package
...
* Mon Nov 22 2010 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.2-4
- fixed update script / rpm %files section

* Mon Nov 22 2010 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.2-3
- fixed update script v_upd_sys_sfpanel

* Mon Nov 22 2010 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.2-2
- removed user sfpanel user from rpm
- fixed %postun script

* Mon Nov 22 2010 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.2-1
...
* Sat Nov 13 2010 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.1-7
...
* Tue Oct 29 2010 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.1-6
- added missing function to db/ip/shared includes

* Tue Oct 26 2010 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.1-5
...
* Thu Oct 07 2010 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.1-4
- fixed path in php-cgi templates
- increased php_memory_limit up to 32M for wordpress
- updated vsftpd and sudoers configs

* Wed Oct 05 2010 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.1-3
- updated db functions

* Wed Oct 04 2010 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.1-2
- fixed dns installer + added cron job logging

* Wed Sep 15 2010 Serghey Rodin <builder@sfpanel.izetmolla.com> - 0.9.1-1
- created sfpanel api package
