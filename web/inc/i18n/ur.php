...
$LANG['ur'] = array(
    ...
    'Welcome to Sfpanel Control Panel'   => 'Sfpanel کی کنٹرول پینل میں خوش آمدید',
    'MAIL_FROM'   => '<noreply@%s> Sfpanel کی کنٹرول پینل ',
    ...
    'Sfpanel Control Panel Plugins'  => 'Sfpanel کی کنٹرول پینل پلگ انز',
    'preview'  => 'پیش نظارہ',
