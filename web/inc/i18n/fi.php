...
$LANG['fi'] = array(
    ...
    'Welcome to Sfpanel Control Panel' => 'Tervetuloa Sfpanel-hallintapaneeliin',
    'MAIL_FROM' => 'Sfpanel-hallintapaneeli <noreply@%s>',
    'GREETINGS_GORDON_FREEMAN' => "Morjens, %s %s,\n",
    'GREETINGS' => "Morjen,s\n",
    'ACCOUNT_READY' => "Käyttätilisi on luotu ja odottaa innokkaasti ensimmäistä kirjautumista.\n\nhttps://%s/login/\nKäyttäjä: %s\nSalasana: %s\n\n--\nSfpanel-hallintapaneeli\n",
    ...
    'Sfpanel Control Panel Plugins' => 'Sfpanel Hallintapaneeli Lisäosat',
    'preview' => 'esikatselu',
