<?php
/**
 * Sfpanel Serbian sr_SR language file
...
$LANG['sr'] = array(
    ...
    'Welcome to Sfpanel Control Panel'  => 'Dobrodošli u Sfpanel kontrolni panel',
    'MAIL_FROM'  => 'Sfpanel kontrolni panel <noreply@%s>',
    'GREETINGS_GORDON_FREEMAN' => "Poštovani %s %s,\n",
    'GREETINGS' => "Poštovani,\n",
    'ACCOUNT_READY' => "Vaš hosting nalog je kreiran i spreman za korišćenje.\n\nhttps://%s/login/\nKorisničko ime: %s\nŠifra: %s\n\n--\nSfpanel kontrolni panel\n",
    ...
    'Sfpanel Control Panel Plugins' => 'Plugin-ovi',
    'preview' => 'pregled',
    ...
    'Directory download not available in current version' => 'Downloadovanje direktorijuma nije moguće u trenutnoj verziji SfpanelCP. Zapakujte folder pa onda download-ujte tu arhivu',
