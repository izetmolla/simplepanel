...
$LANG['pt-BR'] = array(
    ...
    'Welcome to Sfpanel Control Panel'  => 'Bem vindo ao Painel de Controle Sfpanel',
    'MAIL_FROM'  => 'Painel de Controle Sfpanel <noreply@%s>',
    'GREETINGS_GORDON_FREEMAN' => "Olá, %s %s,\n",
    'GREETINGS' => "Olá,\n",
    'ACCOUNT_READY' => "Sua conta foi criada e está pronta para uso.\n\nhttps://%s/login/\nUsuário: %s\nSenha: %s\n\n--\nPainel de Controle Sfpanel\n",
    ...
    'Sfpanel Control Panel Plugins' => 'Plugins do Painel de Controle Sfpanel',
