<?php
/**
 * SfpanelCP Danish translation
 * Made by Michal Skogemann for MShost (http://mshost.dk)
 * Github - https://github.com/michal78/sfpanelcp-danish/
 * SfpanelCP Forum - https://forum.sfpanel.izetmolla.com/viewtopic.php?f=10&t=9172
 */
...
$LANG['da'] = array(
    ...
    'Welcome to Sfpanel Control Panel'  => 'Velkommen til Sfpanel Kontrolpanel',
    'MAIL_FROM'  => 'Sfpanel Kontrolpanel <noreply@%s>',
    'GREETINGS_GORDON_FREEMAN' => "Hej, %s %s,\n",
    'GREETINGS' => "Hej,\n",
    'ACCOUNT_READY' => "Din konto er oprettet og er klar til brug.\n\nhttps://%s/login/\nBrugernavn: %s\nAdgangskode: %s\n\n--\nSfpanel Kontrolpanel\n",
    ...
    'Sfpanel Control Panel Plugins' => 'Sfpanel Kontrolpanel Plugins',
    'preview' => 'preview',
