...
$LANG['es'] = array(
    ...
    'Welcome to Sfpanel Control Panel'  => 'Bienvenido al Panel de Control Sfpanel',
    'MAIL_FROM'  => 'Panel de Control Sfpanel <noreply@%s>',
    'GREETINGS_GORDON_FREEMAN' => "Hola, %s %s,\n",
    'GREETINGS' => "Hola,\n",
    'ACCOUNT_READY' => "Su cuenta ha sido creada con éxito y ya puede hacer uso de ella en:\n\nhttps://%s/login/\nNombre de usuario: %s\nContraseña: %s\n\n--\nPanel de Control Sfpanel\n",
    ...
    'Sfpanel Control Panel Plugins' => 'Plugins de Sfpanel Control Panel',
