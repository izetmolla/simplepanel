...
function get_favourites(){
    exec (SFPANEL_CMD."v-list-user-favourites ".$_SESSION['user']." json", $output, $return_var);
...
function top_panel($user, $TAB) {
    global $panel;
    $command = SFPANEL_CMD."v-list-user '".$user."' 'json'";
    ...
    $command = SFPANEL_CMD."v-list-user-notifications '".$user."' 'json'";
    exec ($command, $output, $return_var);
