...
class FileManager {
    ...
    public function checkFileType($dir) {
        ...
        exec(SFPANEL_CMD . "v-get-fs-file-type {$this->user} {$dir}", $output, $return_var);
    ...
    function deleteItem($dir, $item) {
        ...
        exec (SFPANEL_CMD . "v-delete-fs-directory {$this->user} {$dir}", $output, $return_var);
    ...
    function copyFile($item, $dir, $target_dir, $filename) {
        ...
        exec (SFPANEL_CMD . "v-copy-fs-file {$this->user} {$src} {$dst}", $output, $return_var);
    ...
    function copyDirectory($item, $dir, $target_dir, $filename) {
        ...
        exec (SFPANEL_CMD . "v-copy-fs-directory {$this->user} {$src} {$dst}", $output, $return_var);
    ...
    function createFile($dir, $filename) {
        ...
        exec (SFPANEL_CMD . "v-add-fs-file {$this->user} {$dir}", $output, $return_var);
	...
	$items = implode(' ', $items_arr);
        ...
        exec (SFPANEL_CMD . "v-add-fs-archive {$this->user} {$dst_item} {$items}", $output, $return_var);
    ...
    function backupItem($item) {
        ...
        exec (SFPANEL_CMD . "v-copy-fs-file {$this->user} {$src_item} {$dst_item}", $output, $return_var);
    ...
    function unpackItem($item, $dir, $target_dir, $filename) {
        ...
        exec (SFPANEL_CMD . "v-extract-fs-archive {$this->user} {$item} {$dst_item}", $output, $return_var);
    ...
    function renameFile($item, $target_name) {
        ...
        exec (SFPANEL_CMD . "v-move-fs-file {$this->user} {$item} {$dst_item}", $output, $return_var);
    ...
    function renameDirectory($item, $target_name) {
        ...
        exec (SFPANEL_CMD . "v-move-fs-directory {$this->user} {$item} {$dst_item}", $output, $return_var);
    ...
    function createDir($dir, $dirname) {
        ...
        exec (SFPANEL_CMD . "v-add-fs-directory {$this->user} {$dir}", $output, $return_var);
    ...
    function chmodItem($dir, $item, $permissions) {
        ...
        exec (SFPANEL_CMD . "v-change-fs-file-permission {$this->user} {$item} {$permissions}", $output, $return_var);
    ...
    function getDirectoryListing($dir = '') {
        ...
        exec (SFPANEL_CMD . "v-list-fs-directory {$this->user} {$dir}", $output, $return_var);
