...
if (empty($_GET['domain'])){
    exec (SFPANEL_CMD."v-list-dns-domains $user json", $output, $return_var);
    ...
    exec (SFPANEL_CMD."v-list-dns-records ".$user." ".escapeshellarg($_GET['domain'])." json", $output, $return_var);
    $data = json_decode(implode('', $output), true);
    $data = array_reverse($data, true);
    unset($output);
