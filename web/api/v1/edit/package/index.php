...
exec (SFPANEL_CMD."v-list-user-package ".$v_package." json", $output, $return_var);
...
if (!empty($_POST['save'])) {
    ...
    // Save changes
    exec (SFPANEL_CMD."v-add-user-package ".$tmpdir." ".$v_package." yes", $output, $return_var);
    ...
    exec (SFPANEL_CMD."v-update-user-package ".$v_package." json", $output, $return_var);
    check_return_code($return_var,$output);
    unset($output);
