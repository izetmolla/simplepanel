...
if (!empty($_POST['save'])) {
    ...
    if (!empty($_POST['v_config'])) {
        ...
        fclose($fp);
        exec (SFPANEL_CMD."v-change-sys-service-config ".$new_conf." mariadb ".$v_restart, $output, $return_var);
...
// List config
exec (SFPANEL_CMD."v-list-sys-mysql-config json", $output, $return_var);
