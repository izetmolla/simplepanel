...
if (!empty($_POST['save'])) {
    ...
    if (!empty($_POST['v_config'])) {
        ...
        fclose($fp);
        exec (SFPANEL_CMD."v-change-sys-service-config ".$new_conf." proftpd ".$v_restart, $output, $return_var);
...
$v_config_path = shell_exec(SFPANEL_CMD.'v-list-sys-proftpd-config plain');
