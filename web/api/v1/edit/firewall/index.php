...
exec (SFPANEL_CMD."v-list-firewall-rule ".$v_rule." json", $output, $return_var);
...
if (!empty($_POST['save'])) {
    ...
    // Change Status
    exec (SFPANEL_CMD."v-change-firewall-rule ".$v_rule." ".$v_action." ".$v_ip."  ".$v_port." ".$v_protocol." ".$v_comment, $output, $return_var);
    check_return_code($return_var,$output);
    unset($output);
