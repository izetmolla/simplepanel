...
exec (SFPANEL_CMD."v-list-cron-job ".$user." ".$v_job." json", $output, $return_var);
...
if (!empty($_POST['save'])) {
    ...
    // Save changes
    exec (SFPANEL_CMD."v-change-cron-job ".$v_username." ".$v_job." ".$v_min." ".$v_hour." ".$v_day." ".$v_month." ".$v_wday." ".$v_cmd, $output, $return_var);
    check_return_code($return_var,$output);
    unset($output);
